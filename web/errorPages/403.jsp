        ...
        <div class="row">
            ...
            <div class="span12">
                ...
                <div class="error-container">
                    ...
                    <h2>Oups! le serveur a rencontré un problème</h2>

                    <div class="error-details">
                        Désolé, une erreur est survenue! Pourquoi ne pas essayer de revenir à la <a href="${sessionScope.lienAccueil}">Page d'accueil</a> Ou contactez votre Développeur
