	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var monthNames = options.monthNames || [ 'Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre' ];
					...
					for(var col = 0; col < maxCol; col++, cellIndex++) {
						...
						if(!row) {
							...
							if(!isSelectable ||
								...
								cellClass = ([ 'dim', 'lun', 'mar', 'mer', 'jeu', 'ven', 'sam' ])[cellDateVal.day];
