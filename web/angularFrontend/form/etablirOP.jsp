...
<form role="form" name="oaform"  ng-model="oa">
    <div class="row-fluid">
        ...
        <div class=" span2">
            <div class="controls ">
                <button style="margin-top: 25px" ng-if="update !== true"type="submit" ng-click="addOA(oa)" data-ng-disabled="oaform.$invalid" class="btn  btn-success ">Enregistrer</button>
            </div>
...
<table class="table table-bordered table-hover table-striped "cellspacing="0" width="100%" >
    ...
    <tbody>
        ...
        <tr class="" ng-repeat="bud in oas">
            ...
            <td >
                <div class="btn-group">
                    <a  href="" ng-click="editeOA($index)" class="btn btn-primary" >  <span class="icon"> <i class="icon-edit"></i> </span></a>  
                    <a class="btn btn-danger"  ng-click="deleteOA($index)" href="" ><span class="icon"> <i class="icon-trash"></i> </span></a>
                </div>
            </td>
