        ...
        <div class="widget-body">
            <div class="bs-docs-example">
                <ul class="nav nav-tabs" id="myTab">
                    <c:if test="${ not empty sessionScope.InfoControl}">
                        <li class="active"><a data-toggle="tab" href="#home">Vos Donnees</a></li>
                        </c:if>
                        <c:if test="${not empty sessionScope.ChangePasseControl}">
                        <li><a data-toggle="tab" href="#profile">Changer Votre Mot De Passe</a></li>
                        </c:if>
                        <c:if test="${ not empty sessionScope.ApparielControl}">
                        <li><a data-toggle="tab" href="#dropdown1">Vos Appareils</a></li>
                        </c:if>
                        <c:if test="${not empty sessionScope.CommandeCourControl}">
