...
<div class="widget">
    ...
    <div class="widget-body">
        ...
        <form method="post"action="parametre?action=getRepporting&vue=Historique MS&niveau=4&nav=2" class="non-region hidden-phone" id_magasin="${categories.get(0).getMagasinSecondaire().getIdMagasin()}">   
            <div class="row-fluid layout-gt-xs-row layout-xs-column">
                <label id="nom_magasin" class="hidden flex-gt-xs-5 flex-xs">${categories.get(0).getMagasinSecondaire().getNomMagasin()}</label>
                ...
                <div class="input-append input-prepend  flex-gt-xs-5 flex-xs">
                    <label class="control-label">Interval</label>
                    <input class="reservation" name="interval" id="" placeholder="interval de temps" type="text">
                </div>
                <button class="btn btn-primary search-catego flex-gt-xs-5 flex-xs" name="parametre?action=ReportingAllUserMSInMS&id_magasin=${categories.get(0).getMagasinSecondaire().getIdMagasin()}" type="submit"><i class="icon-search"></i> </button>
