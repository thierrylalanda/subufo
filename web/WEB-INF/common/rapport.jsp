        ...
        <div class="bs-docs-example">
            ...
            <div class="tab-content" id="myTabContent6">
                <div class="tab-pane fade in" id="widget_tab3">
                    <c:import url="/WEB-INF/common/comparaisonservice.jsp"/>
                </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <form   class="<c:if test="${sessionScope.login.getNiveauAcces() != 4}">hidden</c:if>" >
                                            <div class="row-fluid">
                                ...
                                <div class="widget-body">
                                    <div class="bs-docs-example">
                                        <ul class="nav nav-tabs" id="myTabp">
                                            ...
                                            <li class="li-stat "><a data-toggle="tab" href='#rapport_personnel'>${sessionScope.personnel.getNomPrenom()}</a></li>
                                                ...
                                                <form>
                                                    <div class="row-fluid layout-gt-xs-row layout-xs-row">
                                                        ...
                                                        <div class="control-group span2 flex-gt-xs-15 flex-xs">
                                                            <label class="control-label">Magasin</label>
                                                            <div class="controls ">
                                                                <select name="magasin" id="stat-magasinp" class="magasinP span12">
                                            ...
                                            <div id='rapport_mon_service' class="tab-pane fade">
                                                <form>
                                                    <div class="row-fluid flayout-gt-xs-row layout-xs-row">
                                                        <div class="span2 flex-gt-xs-15 flex-xs">
                                                            <label class="control-label" for="">Annee</label>
                                                            <div class="controls ">
                                                                <select class="all-date span12" name="" id="">
                                                        ...
                                                        <div class="span1 flex-gt-xs-5 flex-xs">
                                                            <button type="submit"  class="span12 btn btn-primary search-service-user" style="margin-top: 25px">
                                                        ...
                                                        <div class="control-group span2 hidden flex-gt-xs-15 flex-xs">
                                                            ...
                                                            <div class="controls ">
                                                                <select name="service" id="" class="span12 service_stat form-control input-lg "  >
                                            ...
                                            <div id='rapport_personnel' class="tab-pane fade">
                                                <form>
                                                    <div class="row-fluid layout-gt-xs-row layout-xs-row">
                                                        ...
                                                        <div class="control-group span2 flex-gt-xs-15 flex-xs <c:if test="${sessionScope.login.getNiveauAcces() != 4}">hidden</c:if>">
                                                                <label class="control-label" for="service">Service</label>
                                                                <div class="controls ">
                                                                    <select name="" id="" class="service_stat form-control input-lg span12"  >
                                                                    <c:if test="${sessionScope.login.getNiveauAcces() != 4}">
                                                                        <option value="${sessionScope.personnel.getService().getIdService()}" selected>${sessionScope.personnel.getService().getNomService()}</option>
                                            ...
                                            <c:if test="${sessionScope.login.getNiveauAcces() == 4}">
                                                <div id='rapport_region' class="tab-pane fade in active">
                                                    <form>
                                                        <div class="row-fluid layout-gt-xs-row flayout-xs-row">
