                    ...
                    <div class="span3 flex-gt-xs-20 flex-xs">
                        ...
                        <div class="controls ">
                            <div class="input-prepend">
                                ...
                                <input id=""  name="interval"type="text" class="span12 reservation m-ctrl-medium span12" />
                            </div>
            ...
            <form method="post" action="parametre?action=camabertAllMS&camabert=oui" class="">
                <div class="row-fluid">
                    ...
                    <div class="span2">
                        ...
                        <div class="controls ">
                            <div class="input-append ">
                                <select class="region_mags_ for_end" name="" id="">
                    ...
                    <div class="control-group span2">
                        <label class="control-label">Magasin</label>
                        <div class="controls ff">
                            <select name="id_magasin" id="" class="magasinS_ all_select">
            ...
            <form method="post" action="parametre?action=camabertAllDirection&camabert=oui">
                <div class="row-fluid">
                    <div class="control-group span2">
                        <label class="control-label">Categorie</label>
                        <div class="controls ">
                            <select name="categorie"multiple="multiple" id="" class="cat_select">
                                <c:forEach items="${categories}" var="cate">
                                    <option value="${cate.getIdCategorieProduit()}">${cate.getTypeCategorie()}</option>
                                </c:forEach>
                            </select>
                    ...
                    <div class="span2">
                        ...
                        <div class="controls ">
                            <div class="input-append ">
                                <select class="region for_end" name="" id="">
                    ...
                    <div class="control-group span2">
                        ...
                        <div class="controls ff">
                            <select name="direction" id="" class="input-lg direction all_select" >
            ...
            <form method="post" action="parametre?action=camabertAllsite&niveau=5&camabert=oui">
                <div class="row-fluid">
                    ...
                    <div class="span2">
                        ...
                        <div class="controls ">
                            <div class="input-append ">
                                <select class="region_ for_end"name="" id="">
                    ...
                    <div class="control-group span2">
                        ...
                        <div class="controls ff">
                            <select name="site" id="" class="input-lg site_ all_select" >
                ...
                <div class="row-fluid">
                    ...
                    <c:if test="${sessionScope.login.getNiveauAcces() == 4}">
                        <div class="span2">
                            ...
                            <div class="controls ">
                                <div class="input-append ">
                                    <select class="region_direction_" name="" id="">
                        ...
                        <div class="control-group span2">
                            <label for="" class="control-label">Direction</label>
                            <div class="controls ">
                                <select name="" id="" class="input-lg direction_service_ for_end">
                    ...
                    <div class="control-group span2">
                        ...
                        <div class="controls ff">
                            <select name="service" id="" class="form-control input-lg service_ all_select"  >
                                <c:if test="${sessionScope.login.getNiveauAcces() != 4}">
            ...
            <form method="post" action="parametre?action=camabertAllPersonnelServiceByPeriode&niveau=5&camabert=oui">
                <div class="row-fluid">
                    ...
                    <c:if test="${sessionScope.login.getNiveauAcces() == 4}">
                        ...
                        <div class="control-group span2">
                            <label for="" class="control-label">Direction</label>
                            <div class="controls ">
                                <select name="" id="" class="input-lg direction_service_ ">
                    ...
                    <div class="control-group span2">
                        <label class="control-label" for="">Service</label>
                        <div class="controls ">
                            <select name="service" id="" class="form-control input-lg service_  for_end"  >
                                <c:if test="${sessionScope.login.getNiveauAcces() != 4}">
                                    <option value="${sessionScope.personnel.getService().getIdService()}" selected>${sessionScope.personnel.getService().getNomService()}</option>
                ...
                <div class="row-fluid">
                    <div class="control-group span2">
                        ...
                        <div class="controls ff">
                            <select name="" id="" class="input-lg personnel_ all_select">
