...
<div class="widget">
    ...
    <div class="widget-body">
        <form method="post"action="parametre?action=getRepporting&vue=editeMagP&niveau=5&nav=3" class="non-regionp hidden-phone" id_magasinP="${categories.get(0).getMagasinPrincipal().getIdMagasin()}">   
            <div class="row-fluid">
                <label id="nom_magasin" class="hidden">${categories.get(0).getMagasinPrincipal().getNomMagasin()}</label>
                <div class="control-group span2">
                    <label class="control-label">Categorie</label>
                    <div class="controls ">
                        <select name="categorie" id="" class="cat_select" multiple="multiple">
                ...
                <div class="span1">
                    <button style="margin-top: 25px"class="btn btn-primary search-catego" name="parametre?action=ReportingAllMSInMP&id_magasinP=${categories.get(0).getMagasinPrincipal().getIdMagasin()}" type="submit"><i class="icon-search"></i> </button>
                </div>
            </div>
        </form>
