...
<form role="form"   ng-model="budget" name="budgetForm" action="personnel?action=updateBudgetMagasin&vue=budget&id_budget=${budget.getIdBudget()}" method="post">
    ...
    <div class="control-group form-group span2 flex-gt-xs-15 flex-xs">
            ...
            <div class="controls ">
                <select name="type_budget" class="form-control span12"  id="">
