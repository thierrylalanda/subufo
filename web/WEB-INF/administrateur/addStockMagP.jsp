                    ...
                    <form class="form-inline" method="post" role="form" action="AjouterStockMP?vue=createMagP&action=formulaire&niveau=5" >
                        ...
                        <div class="row-fluid layout-gt-xs-row layout-xs-column">
                            ...
                            <div class="control-group form-group  span2 flex-gt-xs-15 flex-xs">
                                ...
                                <div class="controls ">
                                    <select class="input-lg form-control  magasinPtocat span12" <c:if test="${disable == 'OK'}">disabled</c:if> name="id_magasinP" required >
                            ...
                            <div class="span2 flex-gt-xs-10 flex-xs">
                                <div class="control-group ">
                                    <button type="submit" class="btn btn-success span12" style="margin-top: 25px" ><i class="icon-shopping-cart"></i></button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <div class="bs-docs-example">
                            ...
                            <hr>
                            <a href="AjouterStockMP?vue=createMagP&action=finis&niveau=5&id_magasinP=1"><button type="button" class="btn btn-success">Enregistrer</button></a>
                            <div class="space15"></div>
                            <div class="space15"></div>
                    ...
                    <form method="post" role="form" id="addstockform" enctype="multipart/form-data" action="UploadFile?vue=createMagP&quel=MP&niveau=5">
                        <div class="row-fluid layout-gt-xs-row layout-xs-column">
                            ...
                            <div class="control-group form-group span2 flex-gt-xs-15 flex-xs">
                                <label class="control-label">Magasin</label>
                                <div class="controls ">
                                    <select class="input-lg form-control idmagasin span12" id="" name="nom_magasin" required >
