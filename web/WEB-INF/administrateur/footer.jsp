...
<script src="js/myjs/models/Data.js" type="text/javascript"></script>
   <c:if test="${vue=='' or vue=='accueil' or vue=='about'}">
...
<c:if test="${vue=='rapport' or vue=='editeMagasinS' or vue=='editeMagP' or vue=='statistiques'}">
...
<script src="js/myjs/controllers/comparaisonService.js" type="text/javascript"></script>
...
<script>
    $(document).ready(function () {
        ...
        $('.selectMS').multiselect({
            ...
            buttonText: function (options, select) {
                if (options.length === 0) {
                    return 'Aucun Element Selectionner ...';
                } else if (options.length > 3) {
                    return 'plus de 3 Elements selectionner!';
                } else {
                    var labels = [];
                    options.each(function () {
                        if ($(this).attr('label') !== undefined) {
...
<!-- END JAVASCRIPTS -->
<script src="js/myjs/controllers/ajaxloader.js" type="text/javascript"></script>
