                ...
                <div id="add-budget" class="tab-pane fade in active">
                    ...
                    <div class="row-fluid">
                        <div class=" span12 text-center text-info"><h2><span class="icon"> <i class="icon-dollar"></i> Budgets</span></h2></div>
                            ...
                            <form ng-app="recherche" ng-controller="recherche" role="form" name="budgetForm" ng-model="budget" action="personnel?action=addBudgetMagasin&vue=budget" method="post">
                                <div class="span12" >
                                    <div class="clearfix">
                                                ...
                                                <div class="row-fluid layout-gt-xs-row layout-xs-column">
                                                    ...
                                                    <div class="span2 flex-gt-xs-15 flex-xs " >
                                                        ...
                                                        <div class=" " >
                                                            ...
                                                            <select name="type_budget" class="span12 " ng-model="budget.type" id="" ng-show="nouveau !== true">
                                                                <option value="">--Aucun</option>
                                                                <c:forEach items="${type_categorie}" var="cats">
                                                                    <c:if test="${empty cats.getStocker()}">
                                                    ...
                                                    <div class="span1 flex-gt-xs-15 flex-xs">
                                                        <strong class="flex">CentreCout</strong>
                        ...
                        <table class="table table-bordered table-hover table-striped simple_print"cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <c:forEach  items="${butget}" var="bud">
                                    <c:if test="${empty bud.getRubriques()}">
                                        <tr class="">
