                ...
                <div id="sidebar" class="nav-collapse collapse">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <c:if test="${not empty sessionScope.lien1 or not empty sessionScope.lien10 or not empty sessionScope.lien58 or not empty sessionScope.lien56 or not empty sessionScope.lien2 or sessionScope.GeneralAdministrateur == 'OK'}">
                            <li class="sub-menu <c:if test="${vue=='perso'or vue=='settingeditgroupe' or vue=='settingresponsable' or vue == 'editePersonnel' or vue=='controlleur' or vue=='settinggroupe'}">active</c:if>">
                                    <a href="javascript:;">
                                        <i class="icon-group"></i> 
                                        <span>Utilisateur/Groupe</span>
                                        <span class="arrow"></span>
                                    </a>
                                    <ul class="sub">
                                    ...
                                    <c:if test="${not empty sessionScope.lien58  or sessionScope.GeneralAdministrateur == 'OK'}">
                                        <li class="sub-menu <c:if test="${vue=='settingresponsable'}">active  </c:if>">
                                                <a href="personnel?vue=settingresponsable&action=allRespo"  class=" " >Niveau Validation</a>
                                            </li>
                                    </c:if>

                                    <c:if test="${not empty sessionScope.lien56  or sessionScope.GeneralAdministrateur == 'OK'}">
                                        <li class="sub-menu <c:if test="${vue == 'settinggroupe' or vue=='settingeditgroupe'}">active  </c:if>">
                        ...
                        <c:if test="${sessionScope.GeneralAdministrateur == 'OK' or not empty sessionScope.lien72 or not empty sessionScope.lien71  or sessionScope.GeneralAdministrateur == 'OK' or not empty sessionScope.lien73}">
                            ...
                            <li class="sub-menu <c:if test="${vue== 'articles' or vue == 'fournisseur' or  vue == 'budget achat' or vue == 'Categories Produits' or vue == 'budget' or vue == 'nature'}">active</c:if>">
                                    ...
                                    <c:if test="${sessionScope.GeneralAdministrateur == 'OK' or not empty sessionScope.lien73}">
                                        <li class="sub-menu <c:if test="${vue=='nature' or vue=='budget achat'}"> active</c:if>" >
                                            <a href="personnel?vue=budget achat&action=allbudget" class="<c:if test="${vue=='budget achat' or vue=='nature'}" >active</c:if>" > Frais non stockés</a>
                                            </li>
                                    </c:if>
                                    <c:if test="${sessionScope.GeneralAdministrateur == 'OK' or not empty sessionScope.lien72 or not empty sessionScope.lien71  or sessionScope.GeneralAdministrateur == 'OK' or not empty sessionScope.lien73}">
                                        <li class="sub-menu <c:if test="${vue=='budget' or vue=='articles' or vue=='Categories Produits'}"> active</c:if>" >
                                            <a href="personnel?vue=budget&action=allbudget" class="<c:if test="${vue=='budget' or vue=='articles' or vue=='Categories Produits'}" >active</c:if>" > Frais stockés</a>
                                            </li>

                                    </c:if>
                                    <c:if test="${not empty sessionScope.lien59  or sessionScope.GeneralAdministrateur == 'OK'}">
                                        <li class="<c:if test="${vue == 'fournisseur'}">active  </c:if>">
                        ...
                        <c:if test="${not empty sessionScope.lien78 or not empty sessionScope.lien77 or not empty sessionScope.lien76 or not empty sessionScope.lien80 or not empty sessionScope.lien81 or not empty sessionScope.lien82 or not empty sessionScope.lien83 or not empty sessionScope.lien47 or not empty sessionScope.lien15 or not empty sessionScope.lien31 or sessionScope.GeneralAdministrateur == 'OK'}">
                            <li class="sub-menu <c:if test="${vue=='etablirOA' or vue=='autorisation' or vue=='caisse' or vue=='validerDemande' or vue=='depensesMission' or vue=='depensesExterne' or vue=='depenses' or vue=='Commande Interne' or vue=='magS'or vue=='editeMagasinS' or vue=='historique'or vue=='editeMagasinS' or vue=='historique' or vue=='comrecu'or vue=='comMag' or vue=='magP' or vue=='editeMagP' or vue =='historiqueMagP' or vue == 'comrecuMagP' or vue== 'comMagP'}">active</c:if>">
                                    <a href="javascript:;">
                                    ...
                                    <c:if test="${not empty sessionScope.lien77 or not empty sessionScope.lien80 or not empty sessionScope.lien81 or not empty sessionScope.lien82 or sessionScope.GeneralAdministrateur == 'OK'}">
                                        <li class="sub-menu <c:if test="${vue=='depensesExterne' }">active</c:if>">
                                                <a class="" href="depense?vue=depensesExterne&action=depenses&isnew=yes">
                                                    ...
                                                    <span>Demande engagement depense</span>
                                                </a>
                                            </li>
                                    </c:if>
                                    <c:if test="${1==2 }">
                                    ...
                                    <c:if test="${not empty sessionScope.lien79 or not empty sessionScope.lien83 or sessionScope.GeneralAdministrateur == 'OK'}">
                                        <li class="sub-menu <c:if test="${vue=='validerOA'}"> active</c:if>">
                                                <a class="" href="validerDepense?vue=validerOA&action=validerDemande">
                        ...
                        <c:if test="${not empty sessionScope.lien67 or sessionScope.GeneralAdministrateur == 'OK'}">
                            <li class="sub-menu <c:if test="${ vue=='reportingDepense' or vue=='statistiques'}">active</c:if>">
                                    <a href="javascript:;">
                        ...
                        <c:if test="${not empty sessionScope.lien66 or sessionScope.GeneralAdministrateur == 'OK'}">
                            <li class="sub-menu <c:if test="${vue=='tableauDeBord' or vue == 'rapport'}">active</c:if>">
                                    <a href="javascript:;">
