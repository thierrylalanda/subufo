    ...
    <div class="widget-body">
        <div class="bs-docs-example">
            ...
            <div class="row-fluid responsive ">
                <form method="post" action="Commande_All_Client?vue=Commande Interne&action=ajouter&niveau=3" class="form-inline" id="commandeClit">
                ...
                <tbody id="tbody">
                    <c:forEach items="${listeoperation}" var="list">
                        <tr class="produits">
                            ...
                            <td class="app">
                                <a title="" href="Commande_All_Client?action=delete&code=${list.getCodeProduit()}&vue=Commande Interne&niveau=3" class="btn btn-primary">  <span class="icon"> <i class="icon-remove"></i> </span></a>
                            </td>
                        </tr>
                    </c:forEach>
            ...
            <div class="row-fluid">
                ...
                <a href="Commande_All_Client?vue=Commande Interne&action=saveClient&niveau=3"data-toggle="tooltip" title='Enregistrer Votre Commande' >  <button type="submit" class="btn  btn-success"><i class="icon-save"></i> Enregistrer</button></a>
