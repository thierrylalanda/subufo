...
<!-- END JAVASCRIPTS -->
<script src="js/myjs/controllers/bordereauPersonnel.js" type="text/javascript"></script>
...
<script>
    ...
    $('.tag').keypress(function () {
        $.ajax({
            ...
            type: "post",
            data: {niveau: 2, categorie: $("#categorie").val()},
            success: function (data) {
                $(".tag").autocomplete({
                    source: data
                });
