...
<div class="row-fluid">
    ...
    <div class="span12">
        <c:import url="/WEB-INF/common/carousel/indexMS.jsp"/>
...
<div class="row-fluid"> 
    ...
    <div class="span3">
        ...
        <c:if test="${sessionScope.agenda.size()!=0}">
            ...
            <a  href="RedirectionVue?vue=agenda&action=autre" class="btn btn-danger popovers"   data-trigger="hover" data-placement="top" data-content="consulter votre Agenda vous avez quelque chose de prevue aujourd'hui" data-original-title="alarm" id="pulsate-regular">
        ...
        <c:if test="${sessionScope.agenda.size()==0}">
            ...
            <a  href="RedirectionVue?vue=agenda" class="btn btn-primary popovers"   data-trigger="hover" data-placement="top" data-content="rien  de prevue aujourd'hui" data-original-title="alarm" id="pulsate-regular">
                <span class='icon icon-calendar' ></span> Mon Agenda
            </a>
            <div class="space20"></div>
        </c:if>
